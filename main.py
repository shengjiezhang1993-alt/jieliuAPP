    ...
    try:
        ...
        dialog = ft.AlertDialog(
            ...
            actions=[
                ...
                ft.Button("保存", on_click=save_new_bill, bgcolor=ft.Colors.BLUE, color=ft.Colors.WHITE)
            ]
        )
        ...
        budget_dialog = ft.AlertDialog(
            ...
            actions=[
                ...
                ft.Button("确认设置", on_click=save_budget, bgcolor=ft.Colors.BLUE, color=ft.Colors.WHITE)
            ]
        )
        ...
        page.add(
            ft.Container(
                content=ft.Column([
                    ft.Text("App 启动失败，后台捕获到异常：", size=18, weight="bold", color="red"),
                    ft.Text(str(e), size=15, color="red_700", weight="bold"),
                    ft.Text("详细报错堆栈 (Traceback)：", size=16, weight="bold"),
                    ft.Text(traceback.format_exc(), size=12, color="black", selectable=True)
